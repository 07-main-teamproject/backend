...
class FoodInfoView(APIView):
    def get(self, request):
        ...
        if food_in_db:
            ...
            food_data = {
                "external_id": food_in_db.external_id,  # external_id로 반환
        ...
        if search_response.status_code == 200:
            ...
            if products:
                ...
                food_data = {
                    "external_id": product.get("code", None),  # 외부 ID
        ...
        return Response({"error": "검색된 음식을 찾을 수 없습니다."}, status=status.HTTP_404_NOT_FOUND)
